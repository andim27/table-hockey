...
package katok
{
	...
	public class KatokModel extends ObjectContainer3D
	{
		...
		public function KatokModel(s_c:Object,init:Object = null)
		{
		...
		private function initMaterials():void {
			var path_model:String="models/";
			var file_material:String="ice_fon_plus.png";
			var urlPath:String=s_conf.site_path+path_model+file_material;
			mat_file_name=new BitmapFileMaterial(urlPath);
			//materialArray = [Cast.material(KatokTexture)];		
		...
		private function buildMeshes():void
		{
			...
			objs.obj0 = {name:"bort_right",  transform:m0, pivotPoint:new Number3D(0,0,0), container:1, bothsides:false, material:null, ownCanvas:true, pushfront:false, pushback:false};
			...
			objs.obj1 = {name:"bort_bottom",  transform:m1, pivotPoint:new Number3D(0,0,0), container:1, bothsides:false, material:null, ownCanvas:true, pushfront:false, pushback:false};
			...
			objs.obj2 = {name:"bort_left",  transform:m2, pivotPoint:new Number3D(0,0,0), container:1, bothsides:false, material:null, ownCanvas:true, pushfront:false, pushback:false};
			...
			objs.obj3 = {name:"bort_top",  transform:m3, pivotPoint:new Number3D(0,0,0), container:1, bothsides:false, material:null, ownCanvas:true, pushfront:false, pushback:false};
			...
			objs.obj4 = {name:"Cube",  transform:m4, pivotPoint:new Number3D(0,0,0), container:1, bothsides:false, material:null, ownCanvas:true, pushfront:false, pushback:true};
			...
			objs.obj5 = {name:"Ice",  transform:m5, pivotPoint:new Number3D(0,0,0), container:1, bothsides:false, material:null, ownCanvas:true, pushfront:false, pushback:true};
		...
		private function buildMaterials():void
		{
				...
				applyMaterialToMesh("bort_right");
				applyMaterialToMesh("bort_bottom");
				applyMaterialToMesh("bort_left");
				applyMaterialToMesh("bort_top");
				applyMaterialToMesh("Cube");
				applyMaterialToMesh("Ice");
		}

		private function applyMaterialToMesh(id:String, bmd:BitmapData=null):void
		{    trace("applyMaterialToMesh "+id);
			for(var i:int;i<meshes.length;++i){
				if(meshes[i].name == id){
					meshes[i].material = materialArray[materialIndex];//--my
					//if(!bmd){
		...
		private function addContainers():void
		{
			...
			aC.push(cont1);
			//addChild(cont1);
			s_conf.scene.addChild(cont1);//--my
			trace("KatokModel added cont1="+cont1);
			var m1:MatrixAway3D = new MatrixAway3D();
			m1.sxx = 1;
			m1.sxy = 0;
			m1.sxz = 0;
